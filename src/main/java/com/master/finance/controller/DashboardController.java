...
public class DashboardController {
    ...
    public String dashboard(Authentication authentication, Model model) {
        ...
        double totalInvested = investments.stream().mapToDouble(i -> i.getAmountInvested() != null ? i.getAmountInvested() : 0).sum();
        double totalProfitLoss = investments.stream().mapToDouble(i -> (i.getCurrentValue() != null ? i.getCurrentValue() : 0) - (i.getAmountInvested() != null ? i.getAmountInvested() : 0)).sum();
